...
# def activity_social_hability(age,genre, stage):
#     respuesta = chain.invoke({
#         "question": f"""
#         Crea un escenario social simple acorde a mi edad de {age} años, en el cual estoy en {stage} y soy de género {genre}. 
